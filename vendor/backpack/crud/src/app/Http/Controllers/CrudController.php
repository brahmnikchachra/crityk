...
class CrudController extends BaseController
{
    ...
    public function create()
    {
        ...
        $this->data['title'] = trans('localhost/itrade-apiadd').' '.$this->crud->entity_name;
    ...
    public function storeCrud(StoreRequest $request = null)
    {
        ...
        \Alert::success(trans('localhost/itrade-apiinsert_success'))->flash();
    ...
    public function edit($id)
    {
        ...
        $this->data['title'] = trans('localhost/itrade-apiedit').' '.$this->crud->entity_name;
    ...
    public function updateCrud(UpdateRequest $request = null)
    {
        ...
        // show a success message
        \Alert::success(trans('localhost/itrade-apiupdate_success'))->flash();
    ...
    public function show($id)
    {
        ...
        $this->data['entry'] = $this->crud->getEntry($id);
        $this->data['crud'] = $this->crud;
        $this->data['title'] = trans('localhost/itrade-apipreview').' '.$this->crud->entity_name;
